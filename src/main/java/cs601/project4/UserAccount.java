		...
		try {
			...
			while (userResult.next()) {
				...
				if (dbUser.equals(user)) {
					...
					String tempbody = " User Name: " + userResult.getString("Email") + "<br>" + "First Name : "
							...
							+ userResult.getString("Lastname") + "<br>" + "City : " + userResult.getString("City")
							+ "<br>" + "Date of Birth : " + userResult.getDate("DateOfBirth") + "<br>" + "Gender : "
			...
			while (eventResult.next()) {
				...
				if (userId == hostId) {
					...
					out.println("<tr>");
					out.print("<td><a href=\"/viewevent?eventId=" + eventId + "&username=" + user + "\" >" + name
							+ "</a></td>");
					out.print("<td>" + loc + "</td>");
